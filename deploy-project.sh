...
ssh -o StrictHostKeyChecking=no -l ec2-user $machine_name  $HOME_DIR/final-project docker system prune -a --volumes -f
ssh -o StrictHostKeyChecking=no -l ec2-user $machine_name  $HOME_DIR/final-project docker-compose up -d
